...
public class Game {
	...
	private void stats() {
		int skill =10, stam =20,luck =10;
		
		System.out.println("-----------------------------");
		System.out.printf("Skill %d Stamina %d Luck %d", skill, stam, luck);
		
	}
	private void look() {
		System.out.println("You are " + player.getCurrentLocation().getDescription());
		System.out.print("Exits: ");
		String destinations = player.getCurrentLocation().getExits();
	...
	private void goRoom(Command command) {
		...
		Room nextRoom = null;
		nextRoom = player.getCurrentLocation().getExit(direction);
